<?php
$pages = [
"client_crm.php" => "Client CRM",
"hotspot_manager.php" => "Hotspot Manager",
"queue_control.php" => "Queue Control",
"network_health_center.php" => "Network Health Center",
"finance_center.php" => "Finance Center",
"installations.php" => "Installations",
"support_tickets.php" => "Support Tickets",
"coverage_zones.php" => "Coverage Zones",
"notifications_center.php" => "Notifications Center",
"backup_center.php" => "Backup Center"
];
...
<tr><td>$title</td><td>Ready</td><td><a class="btn" href="modules.php">Back</a></td></tr>
</table>
</div>
</div>
...
foreach($pages as $file=>$title){
    file_put_contents(__DIR__ . "/" . $file, $template($title));
    echo "Created $file\n";
}

echo "PHASE 2 PAGES INSTALLED ✅\n";
