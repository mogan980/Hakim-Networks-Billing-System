...
function pollPayment(checkout){
 ...
 const timer = setInterval(async()=>{
  ...
  if(d.status === "paid"){
   ...
   window.location.href = "payment_success.php?u="+encodeURIComponent(d.username)+"+"&p="+encodeURIComponent(d.password)+"&p="+encodeURIComponent(d.password)p="+encodeURIComponent(d.password);
  }
