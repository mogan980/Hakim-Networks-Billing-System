...
<h2>Live Data</h2>
<table id="liveTable">
<tr><th>User</th><th>IP Address</th><th>MAC</th><th>Uptime</th><th>Bytes In</th><th>Bytes Out</th></tr>
...
<script>
const MODULE_API = "hotspot_active";
...
async function loadModule(){
    ...
    table.innerHTML = d.html || "<tr><th>User</th><th>IP Address</th><th>MAC</th><th>Uptime</th><th>Bytes In</th><th>Bytes Out</th></tr><tr><td colspan='10'>No data</td></tr>";
}
loadModule();
