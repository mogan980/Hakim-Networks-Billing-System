...
setInterval(loadBandwidthLeaderboard, 10000);
...
loadBypassUsers();
setInterval(loadBypassUsers,10000);
...
<link rel="stylesheet" href="mikrotik_cards_pro.css">
<link rel="stylesheet" href="premium_footer_ui.css">
<link rel="stylesheet" href="bandwidth_pro_card.css">
...
<a href="connected_routers.php">🔌 Connected Routers/APs</a>
<a href="modules.php">🧩 Pro Modules</a>
<a href="smart_vouchers.php">🎟 Smart Vouchers</a>
...
<!-- OLD REVENUE BLOCK HIDDEN -->
</div>


<?php include __DIR__ . "/final_compact_revenue_widget.php"; ?>
...
<script src="live_noc_sync.js"></script>
<script src="mikrotik_live_sync.js"></script>
<script src="mikrotik_cards_live.js"></script>
<script src="interface_live.js"></script>
<script src="client_distribution_pie.js"></script>
<script src="router_interfaces_webfig.js"></script>
<script src="bandwidth_pro_card.js"></script>
<script src="bypassed_users_live.js"></script>
<script src="rx_tx_live_values.js"></script>
<script src="quick_actions_pro.js"></script>
<script>
</script>

<script src="router_status_stable.js"></script>


\n
<script id="HN_SIDEBAR_GROUP_LABELS">
document.addEventListener("DOMContentLoaded",()=>{
  ...
  const groups = [
    {before:["Live NOC","Dashboard","NOC Center"], title:"Overview"},
    {before:["Clients","Packages","Vouchers","Smart Vouchers"], title:"Billing"},
    {before:["Payments","STK Monitor","Revenue"], title:"Revenue"},
    {before:["Routers","Connected Routers/APs","PPPoE","Router Wizard","Health Check"], title:"Network"},
    {before:["Reports","Analytics"], title:"Insights"},
    {before:["Users","Settings","Logout"], title:"System"}
  ];

  const links=[...sidebar.querySelectorAll("a")];

  groups.forEach(g=>{
    const target = links.find(a => g.before.some(x => (a.textContent||"").includes(x)));
    if(target && !target.previousElementSibling?.classList?.contains("sidebar-group-title")){
      const label=document.createElement("div");
      label.className="sidebar-group-title";
