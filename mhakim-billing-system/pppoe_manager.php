...
<h2>Live Data</h2>
<table id="liveTable">
<tr><th>User</th><th>IP Address</th><th>Caller ID</th><th>Uptime</th><th>Service</th></tr>
...
async function loadModule(){
    ...
    table.innerHTML = d.html || "<tr><th>User</th><th>IP Address</th><th>Caller ID</th><th>Uptime</th><th>Service</th></tr><tr><td colspan='10'>No data</td></tr>";
}
loadModule();
