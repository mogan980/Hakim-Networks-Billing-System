...
try{
    ...
    echo "<h2 style='font-family:Arial;color:green'>Expiry Engine Complete ✅</h2>";
    echo "<p style='font-family:Arial'>Expired vouchers disconnected: <b>$count</b></p>";
    echo "<a href='smart_vouchers.php'>Back to Smart Vouchers</a>";
